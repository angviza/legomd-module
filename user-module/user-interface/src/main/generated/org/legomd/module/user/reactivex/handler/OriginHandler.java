...
public class OriginHandler {
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler register(JsonObject user, Handler<AsyncResult<String>> resultHandler) { 
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler login(String loginName, String pwd, Handler<AsyncResult<JsonObject>> resultHandler) { 
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler changePwd(long userId, String pwd, long versions, Handler<AsyncResult<Integer>> resultHandler) { 
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler getMemberById(long userId, Handler<AsyncResult<JsonObject>> resultHandler) { 
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler activateEmailUser(long userId, long versions, Handler<AsyncResult<Integer>> resultHandler) { 
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler findEmailUser(String loginName, Handler<AsyncResult<JsonObject>> resultHandler) { 
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler getUserInfo(long userId, Handler<AsyncResult<JsonObject>> resultHandler) { 
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler updateEmail(long userId, String email, long versions, Handler<AsyncResult<Integer>> handler) { 
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler updateIdcard(long userId, String realName, String idCard, String idCardPositive, String idCardNegative, Handler<AsyncResult<Integer>> handler) { 
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler getIdcardInfo(long userId, Handler<AsyncResult<JsonObject>> handler) { 
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler getBindMobile(long userId, Handler<AsyncResult<JsonObject>> handler) { 
  ...
  public org.legomd.module.user.reactivex.handler.OriginHandler bindMobile(long userId, String mobile, String code, Handler<AsyncResult<Integer>> handler) { 
