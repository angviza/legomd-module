...
public class OriginHandlerVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 
  private final Vertx vertx;
  private final OriginHandler service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public OriginHandlerVertxProxyHandler(Vertx vertx, OriginHandler service){
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public OriginHandlerVertxProxyHandler(Vertx vertx, OriginHandler service, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond);
  }

  public OriginHandlerVertxProxyHandler(Vertx vertx, OriginHandler service, boolean topLevel, long timeoutSeconds) {
      this.vertx = vertx;
