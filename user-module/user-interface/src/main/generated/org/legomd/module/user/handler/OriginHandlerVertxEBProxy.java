...
public class OriginHandlerVertxEBProxy implements OriginHandler {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public OriginHandlerVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public OriginHandlerVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
