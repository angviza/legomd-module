...
public class OriginDaoVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 
  private final Vertx vertx;
  private final OriginDao service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public OriginDaoVertxProxyHandler(Vertx vertx, OriginDao service){
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public OriginDaoVertxProxyHandler(Vertx vertx, OriginDao service, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond);
  }

  public OriginDaoVertxProxyHandler(Vertx vertx, OriginDao service, boolean topLevel, long timeoutSeconds) {
      this.vertx = vertx;
