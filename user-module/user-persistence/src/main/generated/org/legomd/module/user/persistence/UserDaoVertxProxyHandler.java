...
public class UserDaoVertxProxyHandler extends ProxyHandler {
  ...
  public UserDaoVertxProxyHandler(Vertx vertx, UserDao service){
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public UserDaoVertxProxyHandler(Vertx vertx, UserDao service, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond);
  }

  public UserDaoVertxProxyHandler(Vertx vertx, UserDao service, boolean topLevel, long timeoutSeconds) {
      this.vertx = vertx;
