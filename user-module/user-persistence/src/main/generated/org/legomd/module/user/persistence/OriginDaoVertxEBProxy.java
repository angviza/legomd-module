...
public class OriginDaoVertxEBProxy implements OriginDao {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public OriginDaoVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public OriginDaoVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
